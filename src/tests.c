...
int run_tests(int test_cat)
{
	...
	PRINTF(("%*i", -7, -42000));
	PRINTF(("wait for it... %*i", -50, 42));
	PRINTF(("%*i is how many tests are going to be maie", 10, 8000));
	PRINTF(("%*i", -9, 2147483647));
	PRINTF(("%*i", -10, 2147483647));
	PRINTF(("%*i", -11, 2147483647));
	PRINTF(("%*i", -5, (int)-2147483648));
	...
	PRINTF(("%0*i", -7, -42000));
	PRINTF(("wait for it... %*i", -50, 42));
	PRINTF(("%0*i is how many tests are going to be maie", -10, 8000));
	PRINTF(("%0*i", -9, 2147483647));
	PRINTF(("%0*i", -10, 2147483647));
	PRINTF(("%0*i", -11, 2147483647));
	PRINTF(("%0*i", -5, (int)-2147483648));
	...
	PRINTF(("%*u", 6, 42000));
	PRINTF(("%*u", 7, -42000));
	PRINTF(("waut for ut... %*u", 50, 42));
	PRINTF(("%*u us how many tests are goung to be made", 10, 8000));
	PRINTF(("%*u", 9, 2147483647));
	PRINTF(("%*u", 10, 2147483647));
	PRINTF(("%*u", 11, 2147483647));
	PRINTF(("%*u", 5, (int)-2147483648));
	PRINTF(("%*u", 10, (int)-2147483648));
	PRINTF(("%*u", 11, (int)-2147483648));
	PRINTF(("%*u", 12, (int)-2147483648));
	PRINTF(("%*u", 13, (int)-2147483648));
	PRINTF(("%*u, %20u, %*u, %42u", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%15u, %u, %2u, %42u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%*u%*u%2u%u", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("%*uc%*us%2ux%uu", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%-*u", 0, 0));
	PRINTF(("%-*u", 0, 7));
	PRINTF(("%-*u", 0, 237));
	PRINTF(("%-*u", 2, 0));
	...
	PRINTF(("%-*u", 13, (int)-2147483648));
	PRINTF(("%-*u, %20u, %*u, %-42u", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%-15u, %u, %*u, %*u", (int)-2147483648, 3, 30, 4, 5, -1));
	PRINTF(("%-*u%*u%------2u%u", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("%-*uc%*us%2ux%uu", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%0*u", 0, 0));
	PRINTF(("%0*u", 0, 7));
	...
	PRINTF(("%0*u", 7, -42000));
	PRINTF(("waut for ut... %*u", 50, 42));
	PRINTF(("%0*u us how many tests are goung to be made", 10, 8000));
	PRINTF(("%0*u", 9, 2147483647));
	PRINTF(("%0*u", 10, 2147483647));
	PRINTF(("%0*u", 11, 2147483647));
	PRINTF(("%0*u", 5, (int)-2147483648));
	PRINTF(("%0*u", 10, (int)-2147483648));
	PRINTF(("%0*u", 11, (int)-2147483648));
	PRINTF(("%0*u", 12, (int)-2147483648));
	PRINTF(("%0*u", 13, (int)-2147483648));
	PRINTF(("%0*u, %20u, %*u, %-42u", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%015u, %u, %*u, %*u", (int)-2147483648, 3, 30, 4, 5, -1));
	PRINTF(("%0*u%*u%0000002u%u", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("  %0*uc%*us%2ux%ui", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%*u", -2, 0));
	PRINTF(("%*u", -1, -4));
	PRINTF(("%*u", -2, -4));
	PRINTF(("%*u", -3, -4));
	...
	PRINTF(("%*u", -6, 42000));
	PRINTF(("%*u", -7, -42000));
	PRINTF(("wait for it... %*u", -50, 42));
	PRINTF(("%*u is how many tests are going to be maue", 10, 8000));
	PRINTF(("%*u", -9, 2147483647));
	PRINTF(("%*u", -10, 2147483647));
	PRINTF(("%*u", -11, 2147483647));
	PRINTF(("%*u", -5, (int)-2147483648));
	...
	PRINTF(("%0*u", -7, -42000));
	PRINTF(("wait for it... %*u", -50, 42));
	PRINTF(("%0*u is how many tests are going to be maue", -10, 8000));
	PRINTF(("%0*u", -9, 2147483647));
	PRINTF(("%0*u", -10, 2147483647));
	PRINTF(("%0*u", -11, 2147483647));
	PRINTF(("%0*u", -5, (int)-2147483648));
	...
	PRINTF(("%015u, %u, %*u, %*u", (int)-2147483648, 3, -30, 4, -5, -1));
	PRINTF(("%0*u%*u%0000002u%u", -5, (int)-2147483648, -10, 3, 30, -1));
	PRINTF(("%0*uc%*us%2ux%uu", -7, (int)-2147483648, -3, 30, -5, -1));
	
	right_cat = test_cat ? test_cat & CAT_X : 1;
	describe("\nTest %x with some * widths");
	...
	PRINTF(("%*x", 6, 42000));
	PRINTF(("%*x", 7, -42000));
	PRINTF(("waxt for xt... %*x", 50, 42));
	PRINTF(("%*x xs how many tests are goxng to be made", 10, 8000));
	PRINTF(("%*x", 9, 2147483647));
	PRINTF(("%*x", 10, 2147483647));
	PRINTF(("%*x", 11, 2147483647));
	PRINTF(("%*x", 5, (int)-2147483648));
	PRINTF(("%*x", 10, (int)-2147483648));
	PRINTF(("%*x", 11, (int)-2147483648));
	PRINTF(("%*x", 12, (int)-2147483648));
	PRINTF(("%*x", 13, (int)-2147483648));
	PRINTF(("%*x, %20x, %*x, %42x", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%15x, %x, %2x, %42x", (int)-2147483648, 3, 30, -1));
	PRINTF(("%*x%*x%2x%x", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("%*xc%*xs%2xx%xx", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%-*x", 0, 0));
	PRINTF(("%-*x", 0, 7));
	PRINTF(("%-*x", 0, 237));
	PRINTF(("%-*x", 2, 0));
	...
	PRINTF(("%-*x", 13, (int)-2147483648));
	PRINTF(("%-*x, %20x, %*x, %-42x", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%-15x, %x, %*x, %*x", (int)-2147483648, 3, 30, 4, 5, -1));
	PRINTF(("%-*x%*x%------2x%x", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("%-*xc%*xs%2xx%xx", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%0*x", 0, 0));
	PRINTF(("%0*x", 0, 7));
	...
	PRINTF(("%0*x", 7, -42000));
	PRINTF(("waxt for xt... %*x", 50, 42));
	PRINTF(("%0*x xs how many tests are goxng to be made", 10, 8000));
	PRINTF(("%0*x", 9, 2147483647));
	PRINTF(("%0*x", 10, 2147483647));
	PRINTF(("%0*x", 11, 2147483647));
	PRINTF(("%0*x", 5, (int)-2147483648));
	PRINTF(("%0*x", 10, (int)-2147483648));
	PRINTF(("%0*x", 11, (int)-2147483648));
	PRINTF(("%0*x", 12, (int)-2147483648));
	PRINTF(("%0*x", 13, (int)-2147483648));
	PRINTF(("%0*x, %20x, %*x, %-42x", 10, (int)-2147483648, 3, 3, 30, -1));
	PRINTF(("%015x, %x, %*x, %*x", (int)-2147483648, 3, 30, 4, 5, -1));
	PRINTF(("%0*x%*x%0000002x%x", 5, (int)-2147483648, 10, 3, 30, -1));
	PRINTF(("  %0*xc%*xs%2xx%xi", 7, (int)-2147483648, 3, 30, -5, -1));
	PRINTF(("%*x", -2, 0));
	PRINTF(("%*x", -1, -4));
	PRINTF(("%*x", -2, -4));
	PRINTF(("%*x", -3, -4));
	...
	PRINTF(("%*x", -6, 42000));
	PRINTF(("%*x", -7, -42000));
	PRINTF(("wait for it... %*x", -50, 42));
	PRINTF(("%*x is how many tests are going to be maxe", 10, 8000));
	PRINTF(("%*x", -9, 2147483647));
	PRINTF(("%*x", -10, 2147483647));
	PRINTF(("%*x", -11, 2147483647));
	PRINTF(("%*x", -5, (int)-2147483648));
	...
	PRINTF(("%*x, %20x, %*x, %42x", -10, (int)-2147483648, 3, 3, -30, -1));
	PRINTF(("%*x%*x%2x%x", -5, (int)-2147483648, -10, 3, 30, -1));
	PRINTF(("%*xc%*xs%2xx%xu", -7, (int)-2147483648, -3, 30, -5, -1));
	PRINTF(("%-*x", -0, 7));
	PRINTF(("%-*x", -0, 237));
	PRINTF(("%-*x", -2, 0));
	PRINTF(("%-*x", -1, -4));
	...
	PRINTF(("%0*x", -7, -42000));
	PRINTF(("wait for it... %*x", -50, 42));
	PRINTF(("%0*x is how many tests are going to be maxe", -10, 8000));
	PRINTF(("%0*x", -9, 2147483647));
	PRINTF(("%0*x", -10, 2147483647));
	PRINTF(("%0*x", -11, 2147483647));
	PRINTF(("%0*x", -5, (int)-2147483648));
