...
int main(int argc, char *argv[])
{
	...
	PRINTF(("%05u", (int)-2147483648));
	PRINTF(("%030u", (int)-2147483648));
	PRINTF(("%010u", (int)-2147483648));
	PRINTF(("%011u", (int)-2147483648));
	PRINTF(("%012u", (int)-2147483648));
	PRINTF(("%012u, %20u, %2u, %42u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%012u, %u, %2u, %42u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%014u%020u%02u%0u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%014uc%020us%02ux%0ui", (int)-2147483648, 3, 30, -1));
	PRINTF(("%01.u", 0));
	PRINTF(("%01.0u", 0));
	PRINTF(("%02.0u", 0));
	PRINTF(("%03.0u", 0));
	...
	PRINTF(("%020.10u", -42000));
	PRINTF(("%020.20u", -42000));
	PRINTF(("%020.30u", -42000));
	...
	PRINTF(("%011u", (int)-2147483648));
	PRINTF(("%012u", (int)-2147483648));
	PRINTF(("%012u, %20u, %2u, %000042u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%012u, %u, %002u, %42u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%0014.2u%020u%0002.u%000.5u", (int)-2147483648, 3, 30, -1));
	PRINTF(("%014uc%020us%02ux%0ui", (int)-2147483648, 3, 30, -1));
